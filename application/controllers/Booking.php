...
class Booking extends CI_Controller 
{
	...
	public function tambahBooking() 
	{
		...
		if ($databooking > 0) {
			...
			danger alert-message" role="alert">Masih Ada booking buku sebelumnya yang belum diambil.<br> Ambil Buku yang dibooking atau tunggu 1x24 Jam untuk bisa booking kembali </div>') 
			;
			redirect(base_url()); 
		}
	...
	public function exportToPdf() 
	{
		...
		include $root."/pustaka-booking_19200870/application/third_party/dompdf/autoload.inc.php";
